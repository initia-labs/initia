...
the 'tests' directory`)
	...
	cmd.Flags().String(flagCompilerVersion, "latest_stable", "Specify the version of the compiler to use")
	cmd.Flags().String(flagLanguageVersion, "latest_stable", "Specify the version of the language to use")
