...
type Params struct {
	...
	ContractSharedRevenueRatio cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=contract_shared_revenue_ratio,json=contractSharedRevenueRatio,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"contract_shared_revenue_ratio" yaml:"contract_shared_revenue_ratio"`
...
var fileDescriptor_5ab4b0783858a3a5 = []byte{
	...
	,
}
