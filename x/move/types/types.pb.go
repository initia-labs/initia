...
type Params struct {
	...
	BaseMinGasPrice  github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_min_gas_price,json=baseMinGasPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"base_min_gas_price" yaml:"base_min_gas_price"`
	...
	ContractSharedRevenueRatio github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=contract_shared_revenue_ratio,json=contractSharedRevenueRatio,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"contract_shared_revenue_ratio" yaml:"contract_shared_revenue_ratio"`
...
type RawParams struct {
	...
	BaseMinGasPrice github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_min_gas_price,json=baseMinGasPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"base_min_gas_price" yaml:"base_min_gas_price"`
	// CSR: Percentage of fees distributed to developers
	ContractSharedRevenueRatio github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=contract_shared_revenue_ratio,json=contractSharedRevenueRatio,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"contract_shared_revenue_ratio" yaml:"contract_shared_revenue_ratio"`
}
...
var fileDescriptor_5ab4b0783858a3a5 = []byte{
	...
	,
}
