...
import (
	...
	movebank "github.com/initia-labs/initia/v1/x/bank/keeper"
	"github.com/initia-labs/initia/v1/x/distribution"
	...
	"github.com/initia-labs/initia/v1/x/evidence"
...
func _createTestInput(
	...
	*moveKeeper = *movekeeper.NewKeeper(
	...
	slashingKeeper.SetParams(ctx, slashingParams)
	stakingKeeper.SetHooks(
		stakingtypes.NewMultiStakingHooks(distKeeper.Hooks(), slashingKeeper.Hooks()),
	)
...
func createValidatorWithBalanceAndGetPk(
	ctx sdk.Context,
	input TestKeepers,
	balance int64,
	delBalance int64,
	index int,
) (sdk.ValAddress, cryptotypes.PubKey) {
	valPubKey := testutilsims.CreateTestPubKeys(index)[index-1]
