...
func TestGetValidatorPowerRank(t *testing.T) {
	...
	val1.VotingPower = sdk.ZeroInt()
	val2, val3, val4 := val1, val1, val1
	val2.VotingPower = sdk.TokensFromConsensusPower(1, sdk.DefaultPowerReduction)
	val3.VotingPower = sdk.TokensFromConsensusPower(10, sdk.DefaultPowerReduction)
	x := new(big.Int).Exp(big.NewInt(2), big.NewInt(40), big.NewInt(0))
	val4.VotingPower = sdk.TokensFromConsensusPower(x.Int64(), sdk.DefaultPowerReduction)
