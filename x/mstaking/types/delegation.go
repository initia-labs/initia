...
func NewRedelegationEntry(creationHeight int64, completionTime time.Time, balance sdk.Coins, sharesDst sdk.DecCoins, unbondingId uint64) RedelegationEntry {
...
// AddEntry - append entry to the unbonding delegation
func (red *Redelegation) AddEntry(creationHeight int64, minTime time.Time, balance sdk.Coins, sharesDst sdk.DecCoins, unbondingId uint64) {
...
func NewRedelegationEntryResponse(
	creationHeight int64, completionTime time.Time, sharesDst sdk.DecCoins, initialBalance, balance sdk.Coins, unbondingId uint64,
