...
func (h Hooks) AfterValidatorRemoved(ctx sdk.Context, _ sdk.ConsAddress, valAddr sdk.ValAddress) error {
	// fetch outstanding
	outstanding := h.k.GetValidatorOutstandingRewardsPools(ctx, valAddr)

	// force-withdraw commission
	commissions := h.k.GetValidatorAccumulatedCommission(ctx, valAddr).Commissions
...
func (h Hooks) BeforeValidatorSlashed(ctx sdk.Context, valAddr sdk.ValAddress, fractions sdk.DecCoins) error {
	h.k.updateValidatorSlashFraction(ctx, valAddr, fractions)
	return nil
}
