...
func (cs ClientState) VerifyUpgradeAndUpdateState(
	...
	newClientState := NewClientState(
		...
		cs.AttestorPubkeys, cs.Threshold,
	)
	...
	newConsState := NewConsensusState(
		tmUpgradeConsState.Timestamp, commitmenttypes.NewMerkleRoot([]byte(tmlightclient.SentinelRoot)), tmUpgradeConsState.NextValidatorsHash,
	)
