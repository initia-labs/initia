...
var (
	...
	ErrAbiEncoding                  = errorsmod.Register(ModuleName, 12, "failed to encode packet data as ABI")
	ErrAbiDecoding                  = errorsmod.Register(ModuleName, 13, "failed to decode ABI packet data")
)
