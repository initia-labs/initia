...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	legacy.RegisterAminoMsg(cdc, &MsgUpdateChannelRelayer{}, "ibc-perm/MsgUpdateChannelRelayer")
}

// RegisterInterfaces register the ibc perm module interfaces to protobuf
// Any.
func RegisterInterfaces(registry codectypes.InterfaceRegistry) {
	registry.RegisterImplementations((*sdk.Msg)(nil), &MsgUpdateChannelRelayer{})
