...
type HookData struct {
	...
	// MessageJSON is a move execute message in JSON format
	// which will be executed at `OnRecvPacket` of receiver chain.
	MessageJSON *movetypes.MsgExecuteJSON `json:"message_json,omitempty"`
