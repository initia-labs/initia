...
require (
	...
	github.com/initia-labs/OPinit v0.1.0-beta.3.0.20231228113819-f63e6d88dd7c
	// we also need to update `LIBINITIAVM_VERSION` of images/private/Dockerfile#5
	github.com/initia-labs/initiavm v0.1.2-beta.5.0.20240102053846-0b62b46550b7
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/initia-labs/cosmos-sdk v0.0.0-20231219050537-ea9a3961f9a4
