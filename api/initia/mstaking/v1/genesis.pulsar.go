...
var (
	...
	fd_GenesisState_next_unbonding_id     protoreflect.FieldDescriptor
)

func init() {
	file_initia_mstaking_v1_genesis_proto_init()
	md_GenesisState = File_initia_mstaking_v1_genesis_proto.Messages().ByName("GenesisState")
	...
	fd_GenesisState_next_unbonding_id = md_GenesisState.Fields().ByName("next_unbonding_id")
}
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_initia_mstaking_v1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Redelegations) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_6_list{list: &x.Redelegations})
	...
	if x.NextUnbondingId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.NextUnbondingId)
		if !f(fd_GenesisState_next_unbonding_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "initia.mstaking.v1.GenesisState.params":
		return x.Params != nil
	case "initia.mstaking.v1.GenesisState.last_validator_powers":
		return len(x.LastValidatorPowers) != 0
	case "initia.mstaking.v1.GenesisState.validators":
		return len(x.Validators) != 0
	case "initia.mstaking.v1.GenesisState.delegations":
		return len(x.Delegations) != 0
	case "initia.mstaking.v1.GenesisState.unbonding_delegations":
		return len(x.UnbondingDelegations) != 0
	case "initia.mstaking.v1.GenesisState.redelegations":
		return len(x.Redelegations) != 0
	case "initia.mstaking.v1.GenesisState.exported":
		return x.Exported != false
	case "initia.mstaking.v1.GenesisState.next_unbonding_id":
		return x.NextUnbondingId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: initia.mstaking.v1.GenesisState"))
		}
		panic(fmt.Errorf("message initia.mstaking.v1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "initia.mstaking.v1.GenesisState.redelegations":
		...
		listValue := &_GenesisState_6_list{list: &x.Redelegations}
		return protoreflect.ValueOfList(listValue)
	case "initia.mstaking.v1.GenesisState.exported":
		value := x.Exported
		return protoreflect.ValueOfBool(value)
	case "initia.mstaking.v1.GenesisState.next_unbonding_id":
		value := x.NextUnbondingId
		return protoreflect.ValueOfUint64(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: initia.mstaking.v1.GenesisState"))
		}
		panic(fmt.Errorf("message initia.mstaking.v1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "initia.mstaking.v1.GenesisState.redelegations":
		...
		value := &_GenesisState_6_list{list: &x.Redelegations}
		return protoreflect.ValueOfList(value)
	case "initia.mstaking.v1.GenesisState.exported":
		panic(fmt.Errorf("field exported of message initia.mstaking.v1.GenesisState is not mutable"))
	case "initia.mstaking.v1.GenesisState.next_unbonding_id":
		panic(fmt.Errorf("field next_unbonding_id of message initia.mstaking.v1.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: initia.mstaking.v1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in initia.mstaking.v1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.NextUnbondingId != 0 {
			n += 1 + runtime.Sov(uint64(x.NextUnbondingId))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.NextUnbondingId != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.NextUnbondingId))
			i--
			dAtA[i] = 0x40
		}
		if x.Exported {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 8:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field NextUnbondingId", wireType)
				}
				x.NextUnbondingId = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.NextUnbondingId |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func init() {
	file_initia_mstaking_v1_genesis_proto_init()
	md_LastValidatorPower = File_initia_mstaking_v1_genesis_proto.Messages().ByName("LastValidatorPower")
...
func (x *LastValidatorPower) slowProtoReflect() protoreflect.Message {
	mi := &file_initia_mstaking_v1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_LastValidatorPower) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "initia.mstaking.v1.LastValidatorPower.address":
		return x.Address != ""
	case "initia.mstaking.v1.LastValidatorPower.power":
		return x.Power != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: initia.mstaking.v1.LastValidatorPower"))
		}
		panic(fmt.Errorf("message initia.mstaking.v1.LastValidatorPower does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_LastValidatorPower) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message initia.mstaking.v1.LastValidatorPower does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_LastValidatorPower) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "initia.mstaking.v1.LastValidatorPower.address":
		panic(fmt.Errorf("field address of message initia.mstaking.v1.LastValidatorPower is not mutable"))
	case "initia.mstaking.v1.LastValidatorPower.power":
		panic(fmt.Errorf("field power of message initia.mstaking.v1.LastValidatorPower is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: initia.mstaking.v1.LastValidatorPower"))
		}
...
func (x *fastReflection_LastValidatorPower) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in initia.mstaking.v1.LastValidatorPower", d.FullName()))
	}
	panic("unreachable")
}
...
type GenesisState struct {
	...
	Redelegations []*Redelegation `protobuf:"bytes,6,rep,name=redelegations,proto3" json:"redelegations,omitempty"`
	Exported      bool            `protobuf:"varint,7,opt,name=exported,proto3" json:"exported,omitempty"`
	// sdk missed this
	NextUnbondingId uint64 `protobuf:"varint,8,opt,name=next_unbonding_id,json=nextUnbondingId,proto3" json:"next_unbonding_id,omitempty"`
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_initia_mstaking_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (x *GenesisState) GetNextUnbondingId() uint64 {
	if x != nil {
		return x.NextUnbondingId
	}
	return 0
}
...
func (*LastValidatorPower) Descriptor() ([]byte, []int) {
	return file_initia_mstaking_v1_genesis_proto_rawDescGZIP(), []int{1}
}
...
var File_initia_mstaking_v1_genesis_proto protoreflect.FileDescriptor

var file_initia_mstaking_v1_genesis_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x20, 0x69, 0x6e, 0x69, 0x74,
	0x69, 0x61, 0x2f, 0x6d, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x73,
	0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x05, 0x0a,
	...
	0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x85, 0x01, 0x0a,
	0x15, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x5f,
	0x70, 0x6f, 0x77, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x69,
	...
	,
	...
	0x77, 0x65, 0x72, 0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x42, 0xc0, 0x01,
	0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x2e, 0x6d, 0x73, 0x74,
	0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69,
...
var (
	file_initia_mstaking_v1_genesis_proto_rawDescOnce sync.Once
	file_initia_mstaking_v1_genesis_proto_rawDescData = file_initia_mstaking_v1_genesis_proto_rawDesc
)

func file_initia_mstaking_v1_genesis_proto_rawDescGZIP() []byte {
	file_initia_mstaking_v1_genesis_proto_rawDescOnce.Do(func() {
		file_initia_mstaking_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_initia_mstaking_v1_genesis_proto_rawDescData)
	})
	return file_initia_mstaking_v1_genesis_proto_rawDescData
}

var file_initia_mstaking_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_initia_mstaking_v1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil),        // 0: initia.mstaking.v1.GenesisState
	(*LastValidatorPower)(nil),  // 1: initia.mstaking.v1.LastValidatorPower
	(*Params)(nil),              // 2: initia.mstaking.v1.Params
	(*Validator)(nil),           // 3: initia.mstaking.v1.Validator
	(*Delegation)(nil),          // 4: initia.mstaking.v1.Delegation
	(*UnbondingDelegation)(nil), // 5: initia.mstaking.v1.UnbondingDelegation
	(*Redelegation)(nil),        // 6: initia.mstaking.v1.Redelegation
}
var file_initia_mstaking_v1_genesis_proto_depIdxs = []int32{
	2, // 0: initia.mstaking.v1.GenesisState.params:type_name -> initia.mstaking.v1.Params
	1, // 1: initia.mstaking.v1.GenesisState.last_validator_powers:type_name -> initia.mstaking.v1.LastValidatorPower
	3, // 2: initia.mstaking.v1.GenesisState.validators:type_name -> initia.mstaking.v1.Validator
	4, // 3: initia.mstaking.v1.GenesisState.delegations:type_name -> initia.mstaking.v1.Delegation
	5, // 4: initia.mstaking.v1.GenesisState.unbonding_delegations:type_name -> initia.mstaking.v1.UnbondingDelegation
	6, // 5: initia.mstaking.v1.GenesisState.redelegations:type_name -> initia.mstaking.v1.Redelegation
...
func init() { file_initia_mstaking_v1_genesis_proto_init() }
func file_initia_mstaking_v1_genesis_proto_init() {
	if File_initia_mstaking_v1_genesis_proto != nil {
		return
	}
	file_initia_mstaking_v1_staking_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_initia_mstaking_v1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_initia_mstaking_v1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_initia_mstaking_v1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_initia_mstaking_v1_genesis_proto_goTypes,
		DependencyIndexes: file_initia_mstaking_v1_genesis_proto_depIdxs,
		MessageInfos:      file_initia_mstaking_v1_genesis_proto_msgTypes,
	}.Build()
	File_initia_mstaking_v1_genesis_proto = out.File
	file_initia_mstaking_v1_genesis_proto_rawDesc = nil
	file_initia_mstaking_v1_genesis_proto_goTypes = nil
	file_initia_mstaking_v1_genesis_proto_depIdxs = nil
}
