...
const (
	...
	Query_SimulateProposal_FullMethodName   = "/initia.gov.v1.Query/SimulateProposal"
)
...
func (c *queryClient) SimulateProposal(ctx context.Context, in *QuerySimulateProposalRequest, opts ...grpc.CallOption) (*QuerySimulateProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_SimulateProposal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) EmergencyProposals(context.Context, *QueryEmergencyProposalsRequest) (*QueryEmergencyProposalsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EmergencyProposals not implemented")
}
...
func (UnimplementedQueryServer) SimulateProposal(context.Context, *QuerySimulateProposalRequest) (*QuerySimulateProposalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SimulateProposal not implemented")
}
...
func _Query_SimulateProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_SimulateProposal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
